...
6. [PX-004-G01](tickets/PX-004-G01-snapshot-frame.md) — Deliver catch-up snapshots for collections larger than one frame
7. [PX-005](tickets/PX-005-rss.md) — Add resident memory with accurate units and unavailable states
8. [PX-006](tickets/PX-006-cpu.md) — Add sampled per-process CPU usage
9. [PX-007](tickets/PX-007-summary.md) — Add the first system summary and data-freshness indicator
10. [PX-008](tickets/PX-008-firstgate.md) — Release gate: the minimal read-only monitor
11. [PX-042](tickets/PX-042-metricregistry.md) — Introduce a typed metric catalogue and collection-cost policy
12. [PX-009](tickets/PX-009-sort.md) — Sort by a selected column without losing process identity
13. [PX-010](tickets/PX-010-filter.md) — Add a responsive command filter
14. [PX-010-G01](tickets/PX-010-G01-early-scale.md) — Gate early live collection scale, progress, and resource budgets
15. [PX-068](tickets/PX-068-columns.md) — Let users choose and reorder process columns
16. [PX-011](tickets/PX-011-search.md) — Add find-next/find-previous and jump to PID
17. [PX-012](tickets/PX-012-users.md) — Filter by owner and an explicit PID set
18. [PX-013](tickets/PX-013-inspector.md) — Add a selected-process inspector
19. [PX-014](tickets/PX-014-command.md) — Show full command line and executable context
20. [PX-015](tickets/PX-015-pause.md) — Add sampling interval and a clearly labeled paused view
21. [PX-016](tickets/PX-016-keyboard.md) — Make the basic workflow keyboard accessible
22. [PX-017](tickets/PX-017-follow.md) — Add follow mode and stable viewport behavior
23. [PX-018](tickets/PX-018-tree.md) — Add parent/child process tree navigation
24. [PX-019](tickets/PX-019-threads.md) — Expose user threads and kernel-thread visibility
25. [PX-020](tickets/PX-020-tags.md) — Add stable multi-selection and descendant tagging
26. [PX-021](tickets/PX-021-lastseen.md) — Keep a last-observed record when a process disappears
27. [PX-022](tickets/PX-022-reconnect.md) — Expose disconnect, catch-up, and replacement correctly
28. [PX-023](tickets/PX-023-connect.md) — Add a minimal generic host connection form
29. [PX-024](tickets/PX-024-saved.md) — Save endpoints and safely reattach after client relaunch
30. [PX-025](tickets/PX-025-demo.md) — Add bounded demonstration workloads and latency scenarios
31. [PX-026](tickets/PX-026-automation.md) — Demonstrate semantic inspection without external IPC
32. [PX-026-G01](tickets/PX-026-G01-r1-package.md) — Gate installable R1 with compatibility, privacy, and native verification
33. [PX-027](tickets/PX-027-showcasegate.md) — Release gate: the first polished SRUI showcase
34. [PX-028](tickets/PX-028-policy.md) — Define action authorization and a dry-run action contract
35. [PX-029](tickets/PX-029-handles.md) — Resolve stable Linux process handles before enabling actions
36. [PX-030](tickets/PX-030-terminate.md) — Add confirmed graceful termination of one process
37. [PX-031](tickets/PX-031-outcomes.md) — Distinguish action acknowledgement from observed process outcome
38. [PX-095](tickets/PX-095-multihost.md) — Add multiple isolated host windows
39. [PX-069](tickets/PX-069-screens.md) — Add named saved views and a versioned settings store
40. [PX-070](tickets/PX-070-meterlayout.md) — Configure meter layout and non-graph display modes
41. [PX-070-G01](tickets/PX-070-G01-dashboard-design.md) — Specify the btop-inspired native dashboard and evaluation scope
42. [PX-071](tickets/PX-071-metricprofile.md) — Specify a small retained metrics-visualization profile
43. [PX-072](tickets/PX-072-metricserver.md) — Publish retained metric-series data from the server
44. [PX-073](tickets/PX-073-metricclient.md) — Render native retained gauges and history graphs
45. [PX-054](tickets/PX-054-hostmemory.md) — Add detailed host memory, swap, and huge-page statistics
46. [PX-055](tickets/PX-055-disk.md) — Add host and per-device disk activity
47. [PX-056](tickets/PX-056-network.md) — Add host and per-interface network activity
48. [PX-090](tickets/PX-090-history.md) — Retain a short, explicitly sampled process history
49. [PX-073-G01](tickets/PX-073-G01-dashboard-compose.md) — Compose the native host dashboard and process-history drill-down
50. [PX-073-G02](tickets/PX-073-G02-dashboard-gate.md) — Release gate for the measured native dashboard
51. [PX-091](tickets/PX-091-historicalview.md) — Inspect historical samples without changing live authority
52. [PX-092](tickets/PX-092-snapshotdiff.md) — Compare two recorded samples
53. [PX-093](tickets/PX-093-alerts.md) — Add user-defined threshold observations without automatic remediation
54. [PX-094](tickets/PX-094-export.md) — Export an explicitly selected diagnostic snapshot
55. [PX-096](tickets/PX-096-guided.md) — Add evidence-based explanations and a guided demo
56. [PX-097](tickets/PX-097-beyondgate.md) — Release gate: demonstrate concrete advantages beyond parity
57. [PX-032](tickets/PX-032-stopresume.md) — Add explicit Stop and Continue actions
58. [PX-033](tickets/PX-033-force.md) — Add explicit force termination without automatic escalation
59. [PX-034](tickets/PX-034-signals.md) — Add an advanced signal chooser
60. [PX-035](tickets/PX-035-bulk.md) — Apply actions to a frozen tagged target set
61. [PX-035-G01](tickets/PX-035-G01-action-feasibility.md) — Resolve identity-safe targeting feasibility for advanced controls
62. [PX-036](tickets/PX-036-nice.md) — Read and change nice values with operation-specific safety
63. [PX-037](tickets/PX-037-affinity.md) — Inspect and edit CPU affinity
64. [PX-038](tickets/PX-038-ioprio.md) — Inspect and edit I/O scheduling priority
65. [PX-039](tickets/PX-039-scheduling.md) — Inspect and edit scheduler policy safely
66. [PX-040](tickets/PX-040-autogroup.md) — Expose autogroup identity and priority changes
67. [PX-041](tickets/PX-041-controlgate.md) — Release gate: an everyday process explorer with safe controls
68. [PX-084](tickets/PX-084-virtualization.md) — Make live sorted and filtered collections range-safe
69. [PX-074](tickets/PX-074-displayprefs.md) — Add display preferences and remaining navigation modes
70. [PX-075](tickets/PX-075-startup.md) — Add validated startup options and configuration import
71. [PX-076](tickets/PX-076-runner.md) — Add a bounded server-side diagnostic job runner
72. [PX-057](tickets/PX-057-psi.md) — Add pressure-stall indicators
73. [PX-058](tickets/PX-058-hostextras.md) — Add host identity, task, descriptor, clock, and uptime meter variants
74. [PX-059](tickets/PX-059-battery.md) — Add optional battery and power-source meters
75. [PX-060](tickets/PX-060-gpu.md) — Add optional host GPU monitoring
76. [PX-061](tickets/PX-061-processgpu.md) — Add supported per-process GPU accounting
77. [PX-062](tickets/PX-062-zram.md) — Add zram meters
78. [PX-063](tickets/PX-063-zswap.md) — Add zswap meters
79. [PX-064](tickets/PX-064-zfs.md) — Add ZFS ARC and compressed-ARC meters
80. [PX-065](tickets/PX-065-systemd.md) — Add read-only systemd status and service-count meters
81. [PX-066](tickets/PX-066-openrc.md) — Add read-only OpenRC status meters
82. [PX-067](tickets/PX-067-selinux.md) — Add SELinux state and complete optional-meter registration
83. [PX-085](tickets/PX-085-budgets.md) — Enforce application memory, history, collection, and traffic budgets
84. [PX-077](tickets/PX-077-fds.md) — Inspect open descriptors and file information
85. [PX-078](tickets/PX-078-locks.md) — Inspect active file locks
86. [PX-079](tickets/PX-079-env.md) — Add opt-in environment inspection with privacy controls
87. [PX-080](tickets/PX-080-maps.md) — Inspect memory mappings and related details
88. [PX-081](tickets/PX-081-trace.md) — Launch and stop a process system-call trace
89. [PX-082](tickets/PX-082-traceview.md) — Render bounded trace output and add an optional terminal island
90. [PX-083](tickets/PX-083-backtrace.md) — Collect and display opt-in process/thread backtraces
91. [PX-086](tickets/PX-086-chaos.md) — Run application-specific reconnect and stale-intent fault tests
92. [PX-087](tickets/PX-087-privacy.md) — Audit sensitive data, parsing, and accessibility end to end
93. [PX-088](tickets/PX-088-parity.md) — Close the pinned Linux htop feature ledger
94. [PX-089](tickets/PX-089-package.md) — Package and document the verified Linux/macOS release
95. [PX-043](tickets/PX-043-processfields.md) — Add process identity, timing, and scheduling columns
96. [PX-044](tickets/PX-044-faults.md) — Add faults and context-switch accounting
97. [PX-045](tickets/PX-045-memoryfields.md) — Add detailed low-cost memory columns
98. [PX-046](tickets/PX-046-pss.md) — Add on-demand proportional memory accounting
99. [PX-047](tickets/PX-047-processio.md) — Add per-process I/O counters and rates
100. [PX-048](tickets/PX-048-cgroups.md) — Expose cgroups, namespaces, and container visibility
101. [PX-049](tickets/PX-049-securityfields.md) — Expose OOM, elevated privileges, and security context
102. [PX-050](tickets/PX-050-staleexe.md) — Show command variants and replaced executable/library warnings
103. [PX-051](tickets/PX-051-delayacct.md) — Add optional delay-accounting metrics
104. [PX-052](tickets/PX-052-cpudetail.md) — Add per-CPU usage classes and topology
105. [PX-053](tickets/PX-053-sensors.md) — Add CPU frequency and temperature readings
106. [PX-098](tickets/PX-098-adminspec.md) — Design an optional narrowly privileged remote helper
107. [PX-099](tickets/PX-099-admintransport.md) — Implement the reviewed helper boundary without process-changing operations
108. [PX-100](tickets/PX-100-adminops.md) — Add privileged operations one reviewed operation at a time
109. [PX-101](tickets/PX-101-pcpmetadata.md) — Add a read-only PCP metric catalogue adapter
110. [PX-102](tickets/PX-102-pcpsamples.md) — Fetch and display bounded PCP metric instances
111. [PX-103](tickets/PX-103-pcpscreens.md) — Add declarative dynamic metric views and PCP parity closure
112. [PX-104](tickets/PX-104-portcontract.md) — Freeze the portable collector/action conformance contract
113. [PX-105](tickets/PX-105-darwinbasic.md) — macOS/Darwin: implement the basic read-only collector
114. [PX-106](tickets/PX-106-darwinmetrics.md) — macOS/Darwin: add extended fields and meter families
115. [PX-107](tickets/PX-107-darwinactions.md) — macOS/Darwin: add reviewed process actions and diagnostics
116. [PX-108](tickets/PX-108-darwingate.md) — macOS/Darwin: close the platform feature ledger and release gate
117. [PX-109](tickets/PX-109-freebsdbasic.md) — FreeBSD: implement the basic read-only collector
118. [PX-110](tickets/PX-110-freebsdmetrics.md) — FreeBSD: add extended fields and meter families
119. [PX-111](tickets/PX-111-freebsdactions.md) — FreeBSD: add reviewed process actions and diagnostics
120. [PX-112](tickets/PX-112-freebsdgate.md) — FreeBSD: close the platform feature ledger and release gate
121. [PX-113](tickets/PX-113-netbsdbasic.md) — NetBSD: implement the basic read-only collector
122. [PX-114](tickets/PX-114-netbsdmetrics.md) — NetBSD: add extended fields and meter families
123. [PX-115](tickets/PX-115-netbsdactions.md) — NetBSD: add reviewed process actions and diagnostics
124. [PX-116](tickets/PX-116-netbsdgate.md) — NetBSD: close the platform feature ledger and release gate
125. [PX-117](tickets/PX-117-openbsdbasic.md) — OpenBSD: implement the basic read-only collector
126. [PX-118](tickets/PX-118-openbsdmetrics.md) — OpenBSD: add extended fields and meter families
127. [PX-119](tickets/PX-119-openbsdactions.md) — OpenBSD: add reviewed process actions and diagnostics
128. [PX-120](tickets/PX-120-openbsdgate.md) — OpenBSD: close the platform feature ledger and release gate
129. [PX-121](tickets/PX-121-dragonflybasic.md) — DragonFly BSD: implement the basic read-only collector
130. [PX-122](tickets/PX-122-dragonflymetrics.md) — DragonFly BSD: add extended fields and meter families
131. [PX-123](tickets/PX-123-dragonflyactions.md) — DragonFly BSD: add reviewed process actions and diagnostics
132. [PX-124](tickets/PX-124-dragonflygate.md) — DragonFly BSD: close the platform feature ledger and release gate
133. [PX-125](tickets/PX-125-solarisbasic.md) — Solaris: implement the basic read-only collector
134. [PX-126](tickets/PX-126-solarismetrics.md) — Solaris: add extended fields and meter families
135. [PX-127](tickets/PX-127-solarisactions.md) — Solaris: add reviewed process actions and diagnostics
136. [PX-128](tickets/PX-128-solarisgate.md) — Solaris: close the platform feature ledger and release gate
137. [PX-129](tickets/PX-129-illumosbasic.md) — illumos: implement the basic read-only collector
138. [PX-130](tickets/PX-130-illumosmetrics.md) — illumos: add extended fields and meter families
139. [PX-131](tickets/PX-131-illumosactions.md) — illumos: add reviewed process actions and diagnostics
140. [PX-132](tickets/PX-132-illumosgate.md) — illumos: close the platform feature ledger and release gate
141. [PX-133](tickets/PX-133-tuicore.md) — Build a minimal terminal-only SRUI replica client
142. [PX-134](tickets/PX-134-tuirender.md) — Render the explorer's read-only views in a terminal
143. [PX-135](tickets/PX-135-tuiinput.md) — Add terminal-client semantic editing and safe actions
144. [PX-136](tickets/PX-136-tuigate.md) — Close terminal-only deployment parity
145. [PX-137](tickets/PX-137-ipcspec.md) — Design a permission model for external local automation
146. [PX-138](tickets/PX-138-ipcread.md) — Expose reviewed, opt-in read-only semantic inspection
147. [PX-139](tickets/PX-139-ipcactions.md) — Expose scoped semantic actions to trusted local automation
...
| [PX-004-G01](tickets/PX-004-G01-snapshot-frame.md) | Deliver catch-up snapshots for collections larger than one frame | PX-004 | none |
