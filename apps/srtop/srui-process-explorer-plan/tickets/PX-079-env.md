...
Read [BASELINE.md](../BASELINE.md) and [SOURCES.md](../SOURCES.md). External reference IDs: H5, K1. Verify version-specific OS/API details at implementation time and record exact references in the completion note.
