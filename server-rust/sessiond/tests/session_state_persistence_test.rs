...
use srui_sdk::*;
use srui_sessiond::{
    handle_connection, mint_session_id, ConnectionError, ResumeOutcome, Session, SessionState,
};

fn setup_counter_session(session: &Arc<Session>) -> (NodeId, NodeId, NodeId, NodeId) {
